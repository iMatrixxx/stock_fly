...
from .data.loaders import load_limit_pool_json, load_market_json
...
def run_pipeline(
    ...
    try:
        ...
        context = {}
    return DataBundle(date=date, market=market, limit_pool=limit_pool, context=context)
